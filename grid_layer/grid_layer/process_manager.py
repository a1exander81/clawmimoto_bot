...
def start_grid_bot(symbol: str, config_path: str) -> str:
    """Launch passivbot for a given symbol."""
...
def get_active_grid_bots() -> dict:
    """Return a dict of currently running grid bots and their PIDs."""
    return {
        sym: proc.pid
        for sym, proc in active_grid_bots.items()
